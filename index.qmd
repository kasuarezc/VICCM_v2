    ...
    <div class="news-grid">
     ...
     <article class="news-card reveal">
        <div class="news-image">
          <img src="noticias/2026-07-17_Concurso_Fotografia/images/ConcursoPortada.png" alt="Concurso de Fotografía">
        </div>
        <div class="news-content">
          <span class="news-date">17 Julio 2026</span>
          <h3>Concurso de Fotografía</h3>
          <p>Con tus fotografías, puedes contribuir a que los mamíferos se conozcan mejor y a conservar nuestra fauna.</p>
          <a href="noticias/2026-07-17_Concurso_Fotografia/concurso_fotografia.html" class="news-link">Leer más</a>
        </div>
      </article>
